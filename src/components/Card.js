        ...
        <div >
            ...
            <div className='grid grid-rows-3 grid-cols-5 border-2 m-2 rounded-xl h-[150px]'>
                ...
                <div className='row-span-2 col-span-3 p-3'>
                    <div className='ml-2 '>
                    <Link className='text-'to={`/product/${product.id}`}>
                ...
                <div className='row-span-1 col-span-3 place-self-end mr-2 mb-2 rounded-xl'>
                    <button className='border-2 bg-[#E6034B] text-white p-2 rounded-xl'>
